...
public class CreateJobPayload {
	//instant   variables
	private int mst_platform_id;   // primitive data type variable
	private int mst_service_location_id;
	private int mst_warrenty_status_id;
	private int mst_oem_id;
	
	private Customer customer;  //reference variable for Customer class
	private CustomerAddress customer_address;  
	private CustomerProduct customer_product; 
	private Problems problems[];  //array of Problem class objects
	
	
	public CreateJobPayload(int mst_platform_id, int mst_service_location_id, int mst_warrenty_status_id,
	...
	public String toString() {
		return "CreateJobPayload [mst_platform_id=" + mst_platform_id + ", mst_service_location_id="
				+ mst_service_location_id + ", mst_warrenty_status_id=" + mst_warrenty_status_id + ", mst_oem_id="
				+ mst_oem_id + ", customer=" + customer + ", customer_address=" + customer_address
				+ ", customer_product=" + customer_product + ", problems=" + Arrays.toString(problems) + "]";
	}
